...
For this lab, you will make two files: `lab1.js` and `lab1.test.js`
...
```
### questionTwo(index);
This function should calculate the Fibonacci (Links to an external site.) that corresponds to the `index` given.

The Fibonacci value of a number is the sum of the previous two Fibonacci values; the [Fibonacci](https://en.wikipedia.org/wiki/Fibonacci_number) of any number less than 1 is 0; the Fibonacci Value of 1 is 1; the Fibonacci value of all other numbers is the sum of the previous two Fibonacci numbers.
